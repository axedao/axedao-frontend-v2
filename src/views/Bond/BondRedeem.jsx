...
function BondRedeem({ bond }) {
  ...
  const vestingTime = () => {
    return prettyVestingPeriod(currentBlockTime, bond.bondMaturationTime);
  };
        ...
        <Box className="bond-data">
          <div className="data-row">
            ...
            <Typography className="price-data">
              {isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.interestDue, 4)} AXE`}
            </Typography>
          </div>
          <div className="data-row">
            <Typography>Claimable Rewards</Typography>
            <Typography className="price-data">
              {isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.pendingPayout, 4)} AXE`}
            </Typography>
          </div>
          <div className="data-row">
